...
app = FastAPI(
    ...
    description="Prompt engineering and optimization agent that designs, tests, and iterates on LLM prompts using systematic evaluation, A/B testing, chain-of-thought refinement, and automated prompt versioning with regression detection.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
