"""Prompt Optimization Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Prompt Optimization Agent through a multi-step pipeline.
